(function() {
  ...
  Meteor.methods({
    ...
    upvoteResource: function(resourceId, user){
      var user = getUser(user);
      return upvote.call(this, Resources, resourceId, user);
    },
    downvoteResources: function(resourceId, user){
      var user = getUser(user);
      return downvote.call(this, Resources, resourceId, user);
    },
    cancelUpvoteResources: function(resourceId, user){
      var user = getUser(user);
      return cancelUpvote.call(this, Resources, resourceId, user);
    },
    cancelDownvoteResources: function(resourceId, user){
      var user = getUser(user);
      return cancelDownvote.call(this, Resources, resourceId, user);
    }
  });
